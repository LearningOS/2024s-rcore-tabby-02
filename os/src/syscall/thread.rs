...
pub fn sys_thread_create(entry: usize, arg: usize) -> isize {
    ...
    // resize mutex/sem for the new thread
    process_inner.mutex_allocation.resize(task_len, vec![0; mutex_len]);
    process_inner.mutex_need.resize(task_len, vec![0; mutex_len]);
    process_inner.sem_allocation.resize(task_len, vec![0; sem_len]);
    process_inner.sem_need.resize(task_len, vec![0; sem_len]);
